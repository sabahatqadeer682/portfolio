...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center px-6 pt-32 pb-20 lg:px-10"
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        {/* LEFT - greeting + actions */}
        <div>
          <div className="mb-5 inline-flex items-center gap-2 rounded-md border border-emerald-400/40 bg-emerald-400/10 px-3 py-1.5 font-mono text-[11px] tracking-wider text-emerald-300 uppercase">
          ...
          <h1 className="font-mono text-3xl leading-tight font-bold tracking-tight sm:text-5xl lg:text-6xl">
          ...
          <p className="mt-5 font-mono text-[15px] text-slate-300">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              download
              className="group inline-flex items-center gap-2 rounded-md border border-emerald-400/50 bg-emerald-400/15 px-5 py-2.5 font-mono text-[13px] font-semibold text-emerald-200 shadow-lg shadow-emerald-500/25 transition-all hover:bg-emerald-400/25 hover:text-emerald-100 hover:shadow-emerald-500/45"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex items-center gap-2 rounded-md border border-cyan-400/50 bg-cyan-400/10 px-5 py-2.5 font-mono text-[13px] font-semibold text-cyan-200 shadow-lg shadow-cyan-500/20 transition-all hover:bg-cyan-400/20 hover:text-cyan-100 hover:shadow-cyan-500/35"
            >
            ...
            <Link
              href="#projects"
              className="group inline-flex items-center gap-2 rounded-md border border-slate-700 bg-slate-900/50 px-5 py-2.5 font-mono text-[13px] font-semibold text-slate-200 transition-all hover:border-slate-500 hover:text-slate-50"
            >
        ...
        <div className="term-window">
          ...
          <div className="flex">
            {/* line numbers */}
            <div className="flex-shrink-0 select-none border-r border-slate-800/70 bg-slate-950/50 px-3 py-5 text-right font-mono text-[12px] leading-[1.7] text-slate-700">
              {Array.from({ length: 15 }).map((_, i) => (
                <div key={i}>{i + 1}</div>
              ))}
            </div>
            {/* code */}
            <pre className="flex-1 overflow-x-auto px-5 py-5 font-mono text-[13px] leading-[1.7] whitespace-pre">
              <Line>
